...
namespace MeetingTracker.Controllers
{
    public class MeetingController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MeetingDescription,MeetingDate,StartTime,EndTime,Location,MeetingTypeId", Exclude = "MeetingType,MeetingItemStatuses")] Meeting meeting)
        {
